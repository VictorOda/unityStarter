...
/// HOW TO USE
/// 
/// Create a variable for the ID of the product you want to sell and for the identifier of it on the App Store and Google Play Store.
/// Add the product on the "InitializePurchasing" function.
/// Create a function to buy that product similar to the functions at the end of this script, changing the ID to your item's ID.
/// Handle anything else you need to do when the player buys the product at the "ProcessPurchase" function
/// Call the function from any script using ShopController.instance.<FUNCTION NAME>()
/// </summary>
...
public class ShopController : MonoBehaviour, IStoreListener {
	...
	private string kProductIDConsumable =    "consumable";		// General handle for the consumable product.
	private string kProductIDNonConsumable = "nonconsumable";   // General handle for the non-consumable product.
	private string kProductIDSubscription =  "subscription";    // General handle for the subscription product.

	private string kProductNameAppleConsumable =    "com.unity3d.test.services.purchasing.consumable";      // Apple App Store identifier for the consumable product.
	private string kProductNameAppleNonConsumable = "com.unity3d.test.services.purchasing.nonconsumable";	// Apple App Store identifier for the non-consumable product.
	private string kProductNameAppleSubscription =  "com.unity3d.test.services.purchasing.subscription";    // Apple App Store identifier for the subscription product.

	private string kProductNameGooglePlayConsumable =    "com.unity3d.test.services.purchasing.consumable";     // Google Play Store identifier for the consumable product.
	...
	public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args) 
	{
		...
		{
			Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));//If the consumable item has been successfully purchased, do anything you want.
			//TODO: Give the player a reward;
		}
